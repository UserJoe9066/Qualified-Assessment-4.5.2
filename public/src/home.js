function getTotalBooksCount(books) {
  // YOUR SOLUTION HERE
  // Returns 0 for the provided books parameter if its null, otherwise will return the length property of the supplied array.
...
function getTotalAccountsCount(accounts) {
  // YOUR SOLUTION HERE
  // Returns 0 for the provided accounts parameter if its null, otherwise will return the length property of the supplied array.
...
function getBooksBorrowedCount(books) {
  ...
  // Uses the filter method to search for all false returned values, meaning the book is still borrowed. Then returns the length of the final array indicating total borrowed books count.
  let borrowedBooksCount = books.filter((book) => {
